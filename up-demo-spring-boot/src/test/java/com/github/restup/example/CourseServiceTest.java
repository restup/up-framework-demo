...
import com.github.restup.test.RpcApiTest.Builder;
...
public class CourseServiceTest extends AbstractMockMVCTest {
    protected static final String BASE = "/com/github/restup/example/CourseServiceTest/";
    ...
    public void testGet() {
        ...
        api.get().expectBody("{\"data\":{\"id\":1,\"type\":\"course\",\"name\":\"Physics\",\"universityId\":1}}").ok();
    ...
    public void testCreate() {
        ...
        api.add("{\"data\":{\"name\":\"Bar\",\"universityId\": 1}}")
                .expectBody("{\"data\":{\"id\":\"${json-unit.ignore}\",\"type\":\"course\",\"name\":\"Bar\",\"universityId\":1}}").ok();
    ...
    public void testDelete() {
        // 1. Specify expected body as String
        api.delete().expectBody("{\"data\":{\"id\":1,\"type\":\"course\",\"name\":\"Physics\",\"universityId\":1}}").ok();
